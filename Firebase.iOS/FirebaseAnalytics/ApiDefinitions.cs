...
namespace Firebase.iOS
{
    ...
    interface FIROptions : INSCopying
    {
        ...
        FIROptions Init(string googleAppID, string bundleID, string GCMSenderID, string APIKey, string clientID, string trackingID, string androidClientID, string databaseURL, string storageBucket, string deepLinkURLScheme);
    }
